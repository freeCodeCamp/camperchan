...
const pullComments: Array<{ key: string; message: string }> = [
  ...
  },
  {
    key: "Newbie Mistakes",
    message:
      "Hey there,\n\nThanks for your interest in contributing. We appreciate your efforts, but this PR doesn't follow our guidelines.\n\nPlease join our [Discord](https://discord.gg/KVUmVXA) and ask in our contributing channel to receive guidance on how to get your PR ready for us to review.",
  },
  {
    key: "Not Triaged",
    message:
